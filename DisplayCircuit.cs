    ...
    public class DisplayCircuit
    {
        public static void Circuits(int circuit)
        {
            ...
            switch (circuit)
            {
                ...
                case 9:
                    lenght = 4.31;
                    lapRecord = "1:05.619 Carlos Sainz (2018)   ";
                    drsZones = 2;
                    circuitMap = Colors.LessGray +
                      "\r                                                                                   " +
                ...
                case 13:
                    ...
                    "\n\r                                  F1F1     F1F1F1F1              F1                " +
                    "\n\r                          F1F1F1     F1                          F1                " +
                    "\n\r           F1F1F1F1F1F1F1F1    F1F1   F1                         F1                " +
                    "\n\r          F1                      F1F1                          F1                 " +
                    "\n\r           F1F1F1F1F1F1F1F1F1START1F1-72-LAPS-14-TURNS-F1F1F1F1F1                  " +
                    "\n\r                                                                                   ";
                    break;
                case 14:
                    lenght = 5.79;
            ...
            string circuitInfo = $"\n\r{Colors.Text}  Length - {lenght}KM | {Colors.Green}DRS {Colors.Text}Zones - {drsZones} | {Colors.Magenta}Lap record {Colors.Text}- {lapRecord}";
        ...
        {
            string circuitMap, circuitName, recordHolder, recordYear;
            double lapDistance, raceDistance, recordSec;
            int laps, recordMin;
            switch (circuit)
            {
                case 0:
                ...
                case 3:
                    lapDistance = 4.933;
                    laps = 62;
                    raceDistance = 305.609;
                    recordMin = 1;
                    recordSec = 24.170;
                    recordHolder = "BAREICHELLO";
                    recordYear = "2002";
                    circuitName = "" +
                        "\r\n░██╗███╗░░░███╗░█████╗░██╗░░░░░░█████╗░" +
                        "\r\n░██║████╗░████║██╔══██╗██║░░░░░██╔══██╗" +
                ...
                case 9:
                    lapDistance = 4.411;
                    laps = 70;
                    raceDistance = 308.586;
                    recordMin = 1;
                    recordSec = 15.045;
                    recordHolder = "COULTHARD";
                    recordYear = "2002";
                    circuitName = "" +
                        "\r\n░███╗░░░███╗░█████╗░░██████╗░███╗░░██╗██╗░░░██╗░░░░░█████╗░░█████╗░██╗░░░██╗██████╗░░██████╗" +
                        "\r\n░████╗░████║██╔══██╗██╔════╝░████╗░██║╚██╗░██╔╝░░░░██╔══██╗██╔══██╗██║░░░██║██╔══██╗██╔════╝" +
                ...
                case 10:
                    lapDistance = 5.141;
                    laps = 60;
                    raceDistance = 308.355;
                    recordMin = 1;
                    recordSec = 23.083;
                    recordHolder = "BARRICHELLO";
                    recordYear = "2002";
                    circuitName = "" +
                        "\r\n░░██████╗██╗██╗░░░██╗░░░██╗███████╗██████╗░░██████╗████████╗░█████╗░███╗░░██╗███████╗                        " +
                        "\r\n░██╔════╝██║██║░░░██║░░░██║██╔════╝██╔══██╗██╔════╝╚══██╔══╝██╔══██╗████╗░██║██╔════╝                        " +
            ...
            string circuitInfo = $"{Colors.Yellow}LAP DISTANCE\n{lapDistance} Km\n\nRACE DISTANCE\n{laps} Laps\n{raceDistance} Km\n\nLAP RECORD\n{recordMin}m {recordSec}s\n{recordHolder}\n{recordYear}";
            Console.WriteLine(circuitMap);
            Console.SetCursorPosition(0, 17);
            Console.WriteLine(Colors.Yellow + circuitName);
            Console.SetCursorPosition(0, 0);
            Console.WriteLine(circuitInfo);
            Console.SetCursorPosition(0, 0);
        }
    }
    public class DisplayCircuitRace
    {
        public static readonly string R = "\x1b[38;5;196m", B = "\x1b[38;5;33m", Y = "\x1b[38;5;226m", G = Colors.Green, P = Colors.Magenta, W = Colors.Text, N = Colors.LessGray;
                        ...
                        switch (SelMap)
                        {
                            ...
                            case 1:
                                Console.WriteLine("" +
                                    ...
                                    $"\n  F1                   {G}F1F" + N +
                                    $"\n F1                      {G}F1F" + N +
                                    $"\n F1                        {G}F1{N}               F1{G}F1F1F1F1F1F1F1" +
                                    $"\n{N} F1                          {G}F1F{N}-AUSTRALIA-F1F{G}              F1F1" +
                                    $"\n{N}  F1F1{G}                                                          F1{N}F1" +
                                    $"\n      F1                                                         F1 " +
                                    $"\n     F1                                               F({G}DZ{N})1    F1  " +
