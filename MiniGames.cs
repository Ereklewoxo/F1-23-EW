...
namespace F1_Season_2023_Ew
{
    ...
    public class MiniGames
    {
        ...
        public static int Brakes(Weather weather)
        {
            Random rnd = new();
            Stopwatch stopwatch = new();
            ConsoleKeyInfo key;
        ...
        public static int Speed(Weather weather)
        {
            ConsoleKeyInfo key;
            ...
            for (int i = 1; i < 5 && !(weather is (Weather)1 or (Weather)2 or (Weather)3); i++)
            {
        ...
        public static int FastestLap(int circuit, Weather weather)
        {
            ConsoleKeyInfo key;
            Stopwatch stopwatch = new();
            Random rnd = new();
